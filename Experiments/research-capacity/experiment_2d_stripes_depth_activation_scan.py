...
def main():
    ...
    print("AAT: trainable per-layer sigma, local activation scan, pure 2D")
    ...
    results = []
    for activate_last in [True, False]:
        for depth in range(1, 7):
            results.append(train_one(depth, activate_last, x_train, y_train, x_val, y_val))
    ...
    for r in results:
        ...
        print(
            f"{r['name']:<48} | params {r['params']:6d} | "
