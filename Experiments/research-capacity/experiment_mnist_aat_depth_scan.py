# -*- coding: utf-8 -*-
r"""
experiment_mnist_aat_depth_scan.py
...
Run:
  python experiment_mnist_aat_depth_scan.py
"""
...
def main():
    ...
    print("AAT MNIST depth scan: +1 extra dim, learned-profile sigma warm start, trainable sigma from epoch 0")
