...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--activation-mode", type=str, default="none", choices=["none", "all", "inter"])
...
def main() -> None:
    ...
    print("=" * 110)
    print("Progressive Parentless Additive Gaussian AAT | flattened MNIST | sigma-softplus v6")
    print("=" * 110)
    print(
    ...
    print(
        "training: progressive init; activation mode is configurable; "
    ...
    print(
        ...
        f"sigma_init_mode={args.sigma_init_mode}, activation_mode={args.activation_mode}, activation_angle={args.activation_angle_degrees}"
    )
    ...
    stack = GaussianAATStack([layer1], activation_angle_degrees=float(args.activation_angle_degrees), activation_mode=str(args.activation_mode))
