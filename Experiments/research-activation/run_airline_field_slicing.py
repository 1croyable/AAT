# -*- coding: utf-8 -*-
"""
run_airline_field_slicing.py

Field-slicing AAT experiment on Airline Satisfaction.

Goal
----
Test a cleaner decomposition plus hard post-transport slicing:

    conservative / potential-style anchor field transport
    + post-transport field-response slicing activation
...
Recommended placement:
    C:/Projets/AATField/Experiments/research-activation/run_airline_field_slicing.py
...
def append_csv(path: Path, rows: List[Dict[str, Any]]) -> None:
    ...
    first = [
        ...
        "boundary_margin", "boundary_strength", "child_axis_strength", "slice_strength", "score_margin", "error",
    ]
    keys = []
    for r in rows:
        for k in r.keys():
...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Field-slicing AAT Airline experiment")
    p.add_argument("--data-dir", type=str, default="../data/AirlineSatisfaction")
    p.add_argument("--out-dir", type=str, default="./airline_field_slicing")
    ...
    p.add_argument(
        "--activation-modes",
        type=str,
        default="none,child_score_relu,winner_commit",
        help="none,child_score_relu,child_hard_fold,winner_commit,top2_score_slice,post_relu,child_axis,boundary_push",
    )
    p.add_argument("--layers", type=str, default="2,4,6")
    ...
    p.add_argument("--score-margin", type=float, default=0.0, help="Score threshold/margin used by child/top2 slicing modes.")
