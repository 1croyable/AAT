# -*- coding: utf-8 -*-
"""
run_airline_conservative_field.py

Conservative-field AAT experiment on Airline Satisfaction.

Goal
----
Test a cleaner decomposition:

    conservative / potential-style anchor field transport
    + post-transport field-structured activation
...
Recommended placement:
    C:/Projets/AATField/Experiments/research-activation/run_airline_conservative_field.py
...
def collect_diagnostics(model: ConservativeAATField, x: torch.Tensor, device: torch.device, batch_size: int = 2048) -> Dict[str, Any]:
    ...
    for key in ["state_norm", "move_norm", "move_state_ratio", "energy_delta", "activation_accept_rate", "field_work", "boundary_push_norm", "child_axis_push_norm", "activation_zero_rate"]:
...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Conservative-field AAT Airline experiment")
    p.add_argument("--data-dir", type=str, default="../data/AirlineSatisfaction")
    p.add_argument("--out-dir", type=str, default="./airline_conservative_field")
    ...
    p.add_argument(
        "--activation-modes",
        type=str,
        default="none,energy_drop,boundary_push,child_axis",
        help="none,post_relu,energy_drop,work_clip,boundary_push,child_axis",
    )
    p.add_argument("--layers", type=str, default="1,2,4,6,8")
